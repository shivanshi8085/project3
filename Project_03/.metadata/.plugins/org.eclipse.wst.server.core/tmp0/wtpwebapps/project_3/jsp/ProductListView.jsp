...
<body class="hm">
	...
	<div></div>
	<div>
		<form class="pb-5" action="<%=ORSView.PRODUCT_LIST_CTL%>" method="post">
			<jsp:useBean id="dto" class="in.co.rays.project_3.dto.ProductDTO"
				scope="request"></jsp:useBean>
			<%
				List list1 = (List) request.getAttribute("name");
			%>
			...
			<div class="row">
				...
				&emsp;
				<div class="col-sm-2">
					<input type="text" name="purchesDate" placeholder="Enter purchesDate"
						class="form-control"
						value="<%=ServletUtility.getParameter("purchesDate", request)%>">
				</div>
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: purple;">
							...
							<th width="15%" class="text">Quality</th>
							<th width="15%" class="text">PurchesDate</th>
					...
					<tbody>
						<tr>
							...
							<td class="text"><%=DataUtility.getDateString(dto.getPurchesDate())%></td>
							
							<td class="text"><a href="ProductCtl?id=<%=dto.getId()%>"
							>Edit</a></td>
						</tr>
					</tbody>
					<%
