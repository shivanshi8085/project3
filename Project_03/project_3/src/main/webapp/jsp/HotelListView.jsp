	...
	<div>
		<form class="pb-5" action="<%=ORSView.HOTEL_LIST_CTL%>" method="post">
			...
			<div class="row">
				...
				&emsp;
				<div class="col-sm-2">
					<input type="text" name="deliveryDate" placeholder="Enter deliveryDate"
						class="form-control"
						value="<%=ServletUtility.getParameter("deliveryDate", request)%>">
				</div>
				...
				<table class="table table-bordered table-dark table-hover">
					...
					<tbody>
						<tr>
							...
							<td class="text"><%=DataUtility.getDateString(dto.getDeliveryDate())%></td>
							
							<td class="text"><a href="HotelCtl?id=<%=dto.getId()%>"
							>Edit</a></td>
						</tr>
					</tbody>
					<%
