...
<body class="hm">
				...
				<div class="col-md-4 mb-4">
					<div class="card input-group-addon">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-primary">Update Hotel</h3>
							<%
								} else {
							%>
	...
	<span class="pl-sm-5"><b>DeliveryDate</b>
	<span style="color: red;">*</span></span></br>
	<div class="col-sm-12">
      <div class="input-group">
        <div class="input-group-prepend">
        ...
        <input type="text" id="datepicker2" name="deliveryDate" class="form-control" placeholder="DeliveryDate" readonly="readonly" value="<%=DataUtility.getDateString(dto.getDeliveryDate()) %>">
      </div>
    </div>	
	<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("deliveryDate", request)%></font></br>
					<%
								if (dto.getId()!=null&&id>0) {
							%>
							...
							<div class="text-center">
								...
								<input type="submit" name="operation" class="btn btn-success btn-md" style="font-size: 17px" value="<%=HotelCtl.OP_UPDATE%>"> 
									
									<input type="submit" name="operation" class="btn btn-warning btn-md" style="font-size: 17px" value="<%=HotelCtl.OP_CANCEL%>">
							...
							<div class="text-center">
								...
								<input type="submit" name="operation" class="btn btn-success btn-md" style="font-size: 17px" value="<%=HotelCtl.OP_SAVE%>"> 
								
								<input type="submit" name="operation" class="btn btn-warning btn-md" style="font-size: 17px" value="<%=HotelCtl.OP_RESET%>">
							</div>
